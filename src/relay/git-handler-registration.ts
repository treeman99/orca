...
export function registerGitHandlers(
  ...
  dispatcher.onRequest('git.submoduleDiscard', (p, c) => handlers.submodule.discard(p, c))
  dispatcher.onRequest('git.submoduleRestorePointer', (p) => handlers.submodule.restorePointer(p))
  dispatcher.onRequest('git.submoduleList', (p) => handlers.submodule.list(p))
  dispatcher.onRequest('git.submoduleStage', (p, c) => handlers.submodule.stage(p, c))
  dispatcher.onRequest('git.submoduleUnstage', (p, c) => handlers.submodule.unstage(p, c))
