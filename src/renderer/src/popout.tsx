...
const popoutSurface = new URLSearchParams(window.location.search).get('win')
  ? 'tab-popout'
  : 'dashboard-popout'
installRendererCrashDiagnostics(popoutSurface)
setReactCommitCascadeRendererSurface(popoutSurface)
