...
// Why: this fork narrows TASK_PROVIDERS to GitHub and deletes the Task Sources pane, so
        ...
        <div className="space-y-0.5">
          ...
          <p className="text-xs text-muted-foreground">
            {TASKS_VISIBILITY_STEP_APPLIES
              ...
              : translate(
                  'auto.components.settings.LinearAgentSkillGuide.setupBodyWithoutTaskSources',
                  'Both are required before agents can act on your Linear tickets.'
                )}
          </p>
        </div>
