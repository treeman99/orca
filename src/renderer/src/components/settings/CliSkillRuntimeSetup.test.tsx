...
describe('CliSkillRuntimeSetup runtime helpers', () => {
  ...
  it('scopes the PS5-compatible argv mode when pasted into PowerShell 7', () => {
    ...
    // The command no longer ends in the eval wrapper's nested quotes; command
    // substitution runs the payload in a subshell, so it has no quoting layer to escape.
