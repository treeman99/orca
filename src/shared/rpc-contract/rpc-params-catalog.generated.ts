...
export const RPC_PARAMS_BY_METHOD = {
  ...
  'git.submoduleCommit': GitSubmoduleCommit,
  'git.submoduleDiscard': GitSubmoduleFilePath,
  'git.submoduleList': WorktreeSelectorOfGitParams,
  'git.submodulePull': GitSubmodulePointer,
  'git.submodulePush': GitSubmodulePush,
  'git.submoduleRestorePointer': GitSubmodulePointer,
  'git.submoduleStage': GitSubmodulePaths,
  'git.submoduleStatus': GitSubmoduleStatus,
  'git.submoduleUnstage': GitSubmodulePaths,
