...
const INVENTORY: readonly InventoryGroup[] = [
  {
    ...
    paths: [
      ...
      // Fork-only callsites: upstream's copy of these files does not label agents here.
      ...
      ['src/renderer/src/components/feature-wall/useAiCommitPrSettings.ts', 3],
      ['src/renderer/src/components/floating-terminal/FloatingTerminalWindowControls.tsx', 2],
      [
        'src/renderer/src/components/right-sidebar/source-control/ai/text-generation-dialog-form.tsx',
        2
      ],
      ['src/renderer/src/components/settings/source-control-action-recipe-options.ts', 2],
