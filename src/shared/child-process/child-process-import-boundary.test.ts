 ...
 *
 * Fork delta: upstream's number is 156 as of v1.4.198; this build is 2 BELOW it. The fork owned 8 direct
 ...
 * A merge that resets this to upstream's number makes the ratchet stop reporting real ground.
 */
