import { isExternalAutomationProviderAllowed } from './external-automation-policy-gate'
...
export async function listLocalManager(
  ...
  // Before the PATH probe and the ~/.<provider> read, not after: a refused provider must
  // leave no trace of having looked.
