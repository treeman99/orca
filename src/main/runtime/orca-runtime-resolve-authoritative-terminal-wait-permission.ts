...
import { OrcaRuntimeWithAgentPromptRescue } from './orca-runtime-agent-prompt-rescue'
...
export class OrcaRuntimeWithResolveAuthoritativeTerminalWaitPermission extends OrcaRuntimeWithAgentPromptRescue {
