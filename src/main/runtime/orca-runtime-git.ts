...
import { RuntimeGitSubmoduleCommands } from './runtime-git-submodule-commands'
...
export class RuntimeGitCommands {
  ...
  readonly discardRuntimeGitSubmodulePath: RuntimeGitSubmoduleCommands['discardRuntimeGitSubmodulePath']
  readonly listRuntimeGitSubmodules: RuntimeGitSubmoduleCommands['listRuntimeGitSubmodules']
  readonly stageRuntimeGitSubmodulePaths: RuntimeGitSubmoduleCommands['stageRuntimeGitSubmodulePaths']
  readonly unstageRuntimeGitSubmodulePaths: RuntimeGitSubmoduleCommands['unstageRuntimeGitSubmodulePaths']
  readonly commitRuntimeGitSubmodule: RuntimeGitSubmoduleCommands['commitRuntimeGitSubmodule']
  readonly pushRuntimeGitSubmodule: RuntimeGitSubmoduleCommands['pushRuntimeGitSubmodule']
  readonly pullRuntimeGitSubmodule: RuntimeGitSubmoduleCommands['pullRuntimeGitSubmodule']
  readonly restoreRuntimeGitSubmodulePointer: RuntimeGitSubmoduleCommands['restoreRuntimeGitSubmodulePointer']
  ...
  constructor(host: RuntimeGitCommandHost) {
    ...
    const submodule = new RuntimeGitSubmoduleCommands(host)
    ...
    this.discardRuntimeGitSubmodulePath = submodule.discardRuntimeGitSubmodulePath.bind(submodule)
    this.listRuntimeGitSubmodules = submodule.listRuntimeGitSubmodules.bind(submodule)
    this.stageRuntimeGitSubmodulePaths = submodule.stageRuntimeGitSubmodulePaths.bind(submodule)
    this.unstageRuntimeGitSubmodulePaths = submodule.unstageRuntimeGitSubmodulePaths.bind(submodule)
