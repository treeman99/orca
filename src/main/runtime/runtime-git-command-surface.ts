...
export function installRuntimeGitCommandSurface(
  ...
  Object.assign(target, {
    ...
    discardRuntimeGitSubmodulePath: commands.discardRuntimeGitSubmodulePath.bind(commands),
    listRuntimeGitSubmodules: commands.listRuntimeGitSubmodules.bind(commands),
    stageRuntimeGitSubmodulePaths: commands.stageRuntimeGitSubmodulePaths.bind(commands),
    unstageRuntimeGitSubmodulePaths: commands.unstageRuntimeGitSubmodulePaths.bind(commands),
    commitRuntimeGitSubmodule: commands.commitRuntimeGitSubmodule.bind(commands),
    pushRuntimeGitSubmodule: commands.pushRuntimeGitSubmodule.bind(commands),
    pullRuntimeGitSubmodule: commands.pullRuntimeGitSubmodule.bind(commands),
    restoreRuntimeGitSubmodulePointer: commands.restoreRuntimeGitSubmodulePointer.bind(commands),
