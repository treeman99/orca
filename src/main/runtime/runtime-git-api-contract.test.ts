...
const RPC_TO_RUNTIME_COMMAND = {
  ...
  // Fork: submodule SCM parity with VS Code — the parent gitlink row and the submodule's
  // own status are separate questions, so each write op has its own method.
  'git.submoduleDiscard': 'discardRuntimeGitSubmodulePath',
  'git.submoduleRestorePointer': 'restoreRuntimeGitSubmodulePointer',
  'git.submoduleList': 'listRuntimeGitSubmodules',
  'git.submoduleStage': 'stageRuntimeGitSubmodulePaths',
  'git.submoduleUnstage': 'unstageRuntimeGitSubmodulePaths',
  'git.submoduleCommit': 'commitRuntimeGitSubmodule',
  'git.submodulePush': 'pushRuntimeGitSubmodule',
  'git.submodulePull': 'pullRuntimeGitSubmodule',
