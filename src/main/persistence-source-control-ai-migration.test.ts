...
describe('Store', () => {
  ...
  // This fork offers GitHub only. A profile written before that narrowed carries provider ids
  // that no longer exist, and they must not come back on load — the Tasks picker and the
  // sidebar shortcut both read this list.
